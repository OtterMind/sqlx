...
Load the recipe of the connected datasource, and only that one. Each recipe links the vendor's own documentation for its operations; open the page for the connected version.
