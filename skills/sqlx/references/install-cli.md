...
The repository is https://github.com/OtterMind/sqlx. The supported CLI range for this Skill is `>=0.1.5, <0.2.0`. The local-page commands are not available in 0.1.0; check the actual version before using them.
